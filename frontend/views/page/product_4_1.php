    ...
    <div class="row">
	  ...
	  <div class="product_list text-center">
		...
		<ul class="nav-tabs">
	  	...
	  	<div class="article">        
		   <p><a href="<?php echo site_url('page/product_3_1')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>ELP-0710</a></p>
		   <p><a href="<?php echo site_url('page/product_4_2')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>EDP-S51</a></p>
