   	...
   	<div class="site_map">
		...
		<div class="main_menu"><a href="<?php echo site_url('page/housing/41/51')?>">사업분야</a>
			<ul>
				...
				<li><a href="<?php echo site_url('page/hi/41/150')?>">Home Improvement<br>사업부문</a>
					<!--<ul>
						<li><a href="<?php echo site_url('page/hi/41/150')?>">- HI</a></li>
						<li><a href="<?php echo site_url('#')?>">- 정보통신</a></li>
						<li><a href="<?php echo site_url('#')?>">- CS</a></li>
						<div class="clearfix"></div>
					</ul>-->
				</li>
				<li><a href="<?php echo site_url('page/apartment/41/52')?>">부동산운영 사업부문</a>
					<!--<ul>
		...
		<div class="main_menu"><a href="<?php echo site_url('#')?>">지속가능경영</a>
			<ul>
				<li><a href="<?php echo site_url('#')?>">품질경영</a></li>
				<li><a href="<?php echo site_url('#')?>">안전보건경영</a></li>
				<li><a href="<?php echo site_url('#')?>">환경경영</a></li>
				<li><a href="<?php echo site_url('#')?>">윤리경영</a></li>
			</ul>
		</div>
		<div class="main_menu"><a href="<?php echo site_url('#')?>">투자정보</a>
			<ul>
				<li><a href="<?php echo site_url('#')?>">기업지배구조</a></li>
				<li><a href="<?php echo site_url('#')?>">공시정보</a></li>
				<li><a href="<?php echo site_url('#')?>">재무정보</a></li>
				<li><a href="<?php echo site_url('#')?>">IR Activity</a></li>
		...
		<div class="main_menu"><a href="<?php echo site_url('page/sell_old_list/148')?>">분양정보</a>
			<ul>
