	  		...
	  		<div class="product_content">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						<li>원격제어 : 스마트폰</li>
	  						<li>통화 및 문 열림 : 세대현관/공동현관 방문자 영상 확인 및 통화, 공동현관 문열림, 디지털도어락 문열림 연동</li>
	  						<li>홈 시큐리티 : 비상 호출, 화재, 가스, 방범 금고,  방문자 사진 저장 및 확인</li>
	  						<li>홈 컨트롤 : 에너지 관리(냉난방, 전력 등), 가스,조명, 환기, 커튼, 실시간 원격검침 서브폰 연동(주방TV폰, 욕실TV폰, 욕실폰)</li>
	  						<li>공용시스템 연동 : 차량 입차 정보, 무인택배, 엘리베이터 호출, 지하주차장 비상콜</li>
	  						<li>디지털 컨텐츠 : 날씨 정보, 시간 정보, 상가 정보(상가 컨텐츠 연동 시), 디지털 액자, CCTV, 주차위치 알림, 공지사항, 관리비, 커뮤니티 시설 정보 조회 및 예약(옵션), 영상메모, 음성메모, 전자주민투표</li>
	  					</ul>
	  				</div>
	  				<div class="clearfix"></div>
	  			</div> 
