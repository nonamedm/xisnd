  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						<li>통화방식 : 핸즈프리</li>
	  						<li>호출방식 : 정전식 터치방식</li>
	  						<li>카메라 : 200만화소(FHD)</li>
	  						<li>크기 : 95(W) X 150(H) X 12(D)mm</li>
	  					</ul>
	  				</div>
		...
		<div class="article">    
		   <p><a href="<?php echo site_url('page/product_3_2')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EDP-S50</a></p>
		   <p><a href="<?php echo site_url('page/product_4_3')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>EGP-0710</a></p>
