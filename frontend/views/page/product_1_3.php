  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
	  		...
	  		<div class="product_content">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						<li>디스플레이 : 10.1인치(TFT COLOR), 정전식 터치 스크린</li>
	  						<li>인터페이스 : 터치스크린, 터치버튼 방식</li>
	  						<!-- <li>카메라 : 27만 화소</li> -->
	  						<li>전원 : AC free voltage</li>
	  						<li>크기 : 310(W) X 173.5(H) X 10(D)mm</li>
	  					</ul>
	  				</div>
		...
		<div class="article">        
		   <p><a href="<?php echo site_url('page/product_1_2')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EHW-1050</a></p>
		   <p><a href="<?php echo site_url('page/product_1_4')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>ELP-0710</a></p>
