  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
		...
		<div class="article">    
		   <p><a href="<?php echo site_url('page/product_4_4')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EDP-S50</a></p>
		   <p><a href="<?php echo site_url('page/product_4_1')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>EGP-0710</a></p>
