  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						...
	  						<li>카메라 : 200만화소(FHD) 영상통화용, 안면인식용</li>
	  						<li>전원 : AC free voltage</li>
	  						<li>크기 : 270(W) X 370(H) X 14(D)mm</li>
	  					</ul>
	  				</div>
		...
		<div class="article">        
		   <p><a href="<?php echo site_url('page/product_3_1')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EAW-0710</a></p>
		   <p><a href="<?php echo site_url('page/product_4_4')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>EDP-S50</a></p>
