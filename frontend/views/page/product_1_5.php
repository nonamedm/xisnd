  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
	  		...
	  		<div class="product_content">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						<li>디스플레이 : 13.3인치(FHD), 정전식 터치 스크린</li>
	  						<li>인터페이스 : 터치스크린, 터치버튼 방식</li>
	  						<!-- <li>카메라 : 100만 화소</li> -->
	  						<li>전원 : AC free voltage</li>
	  						<li>크기 : 374.3(W) X 251(H) X 14(D)mm</li>
	  					</ul>
	  				</div>
		...
		<div class="article">        
		   <p><a href="<?php echo site_url('page/product_1_4')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EHW-1050</a></p>
		   <p><a href="<?php echo site_url('page/product_1_6')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>ELP-0710</a></p>
