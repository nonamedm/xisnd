  ...
  <div class="container">
    <div class="row">
	  ...
	  <div class="product_list text-center">
	  			...
	  			<div class="intro text-left">
	  				...
	  				<div class="intro_content">
	  					<ul>
	  						...
	  						<li>크기 : 305(W) X 191(H) X 14(D)mm</li>
	  					</ul>
	  				</div>
		...
		<div class="article">        
		   <p><a href="<?php echo site_url('page/product_1_3')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_top.png" alt=""></i>이전글</b>EHW-1050</a></p>
		   <p><a href="<?php echo site_url('page/product_1_5')?>"><b><i><img src="<?php echo base_url()?>resource/frontend/images/arrow_bottom.png" alt=""></i>도어폰</b>ELP-0710</a></p>
