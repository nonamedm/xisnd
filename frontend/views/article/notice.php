...
<body>
    ...
    <div class="sub4 bg_common">
        <p class="text1">투자정보</p>
        <p class="text2"><img src="/resource/frontend/images/home.png" alt=""><span>투자정보</span>
        
        <?php if( $_GET['search_word']=='공시' ):?>
            <span>공고정보</span>
        <?php endif;?>

        <?php if( $_GET['search_word']=='기사' ):?>
            <span>News</span>
        <?php endif;?>
            ...
            <div class="row">
                <div class="col-xs-12" style="padding-top: 65px; text-align: center;">
                    <?php if( $_GET['search_word']=='공시' ):?>
                        ...
                        <p class="title_text1" style="margin-top: 0px !important;">
                            공고정보
                        </p>
                    <?php endif;?>
                    <?php if( $_GET['search_word']=='기사' ):?>
                    ...
                    <div class="kr_form">
                        <div class="kr_form_table">
                            ...
                            <div class="kr_form_tr form_big_title">
                                ...
                                <div class="kr_form_td form_auther">날짜</div>
                            </div>
