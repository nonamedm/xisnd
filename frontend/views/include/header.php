            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-center" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"> <a href="<?php echo site_url('page/sustainability/152');?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">지속가능경영</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo site_url('page/qualitymanagement/152/153');?>">품질경영</a></li>
                                <li><a href="<?php echo site_url('page/safetymanagement/152/154');?>">안전보건경영</a></li>
                                <li><a href="<?php echo site_url('page/envmanagement/152/155');?>">환경경영</a></li>
                                <li><a href="<?php echo site_url('page/about/42/136');?>">윤리경영</a></li>
                          </ul>
                        </li>

                        <li class="dropdown"> <a href="<?php echo site_url('page/ir/160');?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">투자정보</a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo site_url('page/management/160/161');?>">기업지배구조</a></li>
                                <li><a href="<?php echo site_url('page/announce/160/162');?>">공시정보</a></li>
                                <li><a href="<?php echo site_url('page/financial/160/163');?>">재무정보</a></li>
                                <li><a href="<?php echo site_url('page/iractivity/160/164');?>">IR Activity</a></li>
                                <li><a href="<?php echo site_url('article/notice/43/50?search_word=%EA%B8%B0%EC%82%AC');?>">News</a></li>
                          </ul>
                        </li>
                        ...
                        <li class="dropdown"> <a href="<?php echo site_url('page/sell_old_list/148');?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">분양정보</a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo site_url('page/sell_list/1');?>">공사중 단지</a></li>
                            </ul>
                        </li>
