            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-center" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown"> <a href="<?php echo site_url('#');?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">지속가능경영</a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown"> <a href="<?php echo site_url('#');?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">투자정보</a>
                            <ul class="dropdown-menu">
