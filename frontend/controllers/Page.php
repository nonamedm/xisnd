...
class Page extends Basic_Controller {
    ...
    public function product_1_3()
    {
        $this->load->view('page/product_1_3', $this->data);
    }

    public function product_1_4()
    {
        $this->load->view('page/product_1_4', $this->data);
    }

    public function product_1_5()
    {
        $this->load->view('page/product_1_5', $this->data);
    }

    public function product_1_6()
    {
        $this->load->view('page/product_1_6', $this->data);
    }

    public function product_1_7()
    {
        $this->load->view('page/product_1_7', $this->data);
    }
    ...
    public function product_3_2()
    {
        $this->load->view('page/product_3_2', $this->data);
    }
    ...
    public function product_4_3()
    {
        $this->load->view('page/product_4_3', $this->data);
    }

    public function product_4_4()
    {
        $this->load->view('page/product_4_4', $this->data);
    }
    ...
    {
        $this->load->view('page/sustainability', $this->data);
    }
    ...
    public function qualitymanagement()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/qualitymanagement', $this->data);
    }
    ...
    public function envmanagement()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/envmanagement', $this->data);
    }

    public function ir()
    {
        $this->load->view('page/ir', $this->data);
    }
    ...
    public function management()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/management', $this->data);
    }
    ...
    public function dataURL()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/dataURL', $this->data);
    }
    ...
    public function announce()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/announce', $this->data);
    }
    public function dividendpolicy()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/dividendpolicy', $this->data);
    }
    ...
    public function financial()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/financial', $this->data);
    }

    public function iractivity()
    {
        $this->fetchPageData();
        $this->data['sub_type'] = 'sub4';
        $this->load->view('page/iractivity', $this->data);
    }
